...
import { FeatureCard } from "./platforms/FeatureCard";
import { SectionTitle } from "./platforms/SectionTitle";
import { ProjectDesignIcon, VisualizationIcon, AutomationIcon } from "./icons/PlatformIcons";
