  ...
  const advantages = [
    {
      ...
      icon: (
        <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-10 h-10 text-primary">
            ...
            <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex flex-col gap-3 md:flex-row md:gap-6 md:items-start">
                  <div className="bg-primary/10 p-3 md:p-4 rounded-lg mr-0 md:mr-3">
                    {advantage.icon}
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2 md:mb-0">{advantage.title}</h3>
